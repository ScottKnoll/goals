...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 overflow-x-auto">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold tracking-tight">Create a New Goal</h1>
                <p class="text-muted-foreground">
                    Set a new goal to work towards and track your progress.
                </p>
            </div>
        ...
        <Card class="w-full">
            <CardHeader>
                ...
                <CardDescription>
                    Fill in the details for your new goal. You can always edit these later.
                </CardDescription>
            </CardHeader>
            <CardContent>
