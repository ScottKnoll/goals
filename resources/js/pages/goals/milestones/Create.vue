...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Add Milestone', href: route('goals.milestones.create', props.goal.id) },
]
...
const submit = () => {
    form.post(route('goals.milestones.store', props.goal.id))
}
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 overflow-x-auto">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold tracking-tight">Add Milestone</h1>
                    <p class="text-muted-foreground">
                        Add a milestone to "{{ goal.title }}"
                    </p>
                </div>
            ...
            <Card class="w-full">
                <CardHeader>
                    ...
                    <CardDescription>
                        Define a checkpoint to track progress toward your goal.
                    </CardDescription>
                </CardHeader>
                <CardContent>
